<?php /* Smarty version 2.6.0, created on 2008-07-29 13:07:24
...
<?php endif;  if ($this->_tpl_vars['desc'] != ''): ?><span class="description"><?php echo ((is_array($_tmp=@$this->_tpl_vars['desc'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
</span><?php endif; ?>